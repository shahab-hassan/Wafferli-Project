        ...
        <Card className="rounded-2xl border bg-card p-4 sm:p-6">
          <div className="grid grid-cols-1 gap-5">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              >
                <SelectTrigger className="w-64">
                  <SelectValue placeholder="Electronics & Technology" />
                </SelectTrigger>
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              >
                <SelectTrigger className="w-64">
                  <SelectValue placeholder="Mobile Devices" />
                </SelectTrigger>
                <SelectContent align="end">
                  <SelectItem value="phones">Mobile Devices</SelectItem>
            ...
            <div className="flex items-center justify-end">
              <Button
                ...
                onClick={() => {
                  // Leave wiring to you
                  onContinue?.(values)
                  console.log("[v0] Edit Product Continue clicked with:", values)
                }}
              >
                Continue
