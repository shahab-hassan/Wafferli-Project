...
import { Phone, MapPin, ExternalLink, Star, Check, Facebook, Instagram, Twitter, MessageCircle, Send } from "lucide-react"
    ...
    <Card className="rounded-2xl lg:rounded-3xl border sticky top-4 lg:top-8 ">
      <CardContent className="p-4 sm:p-6 lg:p-8">
        <div className="text-center mb-4 lg:mb-6">
          ...
          <Link href="/profile/business/1">
            <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2 hover:underline cursor-pointer">{business.name}</h3>
          </Link>
        ...
        <div className="space-y-3 lg:space-y-4 mb-4 lg:mb-6">
          ...
          >
            <Phone className="w-4 h-4 lg:w-5 lg:h-5 text-purple-600 flex-shrink-0" />
            <span className="text-purple-600 hover:text-purple-700 font-medium text-sm lg:text-base">
              {business.phone}
            </span>
          </button>
          
          <div className="flex items-start space-x-2 lg:space-x-3 p-1">
            <MapPin className="w-4 h-4 lg:w-5 lg:h-5 text-purple-600 mt-0.5 flex-shrink-0" />
          ...
          <button
            ...
            className="flex items-center space-x-2 lg:space-x-3 w-full text-left hover:bg-gray-50 p-1 rounded-lg transition-colors"
          >
            <ExternalLink className="w-4 h-4 lg:w-5 lg:h-5 text-purple-600 flex-shrink-0" />
            <span className="text-purple-600 hover:text-purple-700 text-sm lg:text-base">
              {business.website}
            </span>
          </button>
        </div>
        ...
        <div className="flex justify-center space-x-2 lg:space-x-3 mb-4 lg:mb-6">
          ...
          <button
            ...
            className="p-2 lg:p-3 bg-pink-100 text-pink-600 rounded-full hover:bg-pink-200 transition-colors"
          >
