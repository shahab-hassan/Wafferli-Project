      ...
      <CardContent className="p-4 sm:p-6 lg:p-8">
        ...
        <div className="bg-gray-50 rounded-xl lg:rounded-2xl p-4 lg:p-6 mb-4 lg:mb-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6">
            <div className="text-center sm:text-left">
              <div className="text-3xl lg:text-4xl font-bold text-purple-600">{offer.rating}</div>
          ...
          <div className="bg-purple-50 rounded-xl lg:rounded-2xl p-4 lg:p-6 mb-4 lg:mb-6">
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <div className="flex space-x-2 lg:space-x-3">
                <Button className="bg-purple-600 rounded-xl lg:rounded-2xl text-sm lg:text-base px-3 lg:px-4 py-2">
                  Submit Review
                </Button>
                <Button
                  variant="outline"
        ...
        {reviews.length > 0 && (
          <div className="text-center mt-4 lg:mt-6">
            <Button
              variant="outline"
              className="rounded-xl lg:rounded-2xl text-sm lg:text-base px-4 lg:px-6 py-2"
            >
              Load More Reviews
            </Button>
          </div>
