...
const demoDeals = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1565299585323-38174c5d5ed6?w=400&h=300&fit=crop",
    location: "SoHo, NY",
    rating: 4.5,
    reviewCount: 73,
    originalPrice: "$28.00",
  ...
  const SectionHeader = ({
    ...
    type: "explore" | "marketplace?tab=services" | "marketplace?tab=products";
    title: string;
    highlight: string;
    description: string;
  }) => (
  ...
  return (
    <div className="flex flex-col justify-center items-center" dir={isRTL ? "rtl" : "ltr"}>
